...
You have to design & build the backend for the application and the ability for the users to register, list properties and search for properties.
...
https://github.com/azaylamba/99acres 
